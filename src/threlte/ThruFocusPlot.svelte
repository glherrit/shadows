<script lang="ts">
  import Coords from '$lib/components/threlte/Coords.svelte'
  ...
  import { findMaxRadius, genSpots } from 'src/lib/analysis/spotd'
  //C:\Users\glher\source\repos\shadows\src\lib\analysis\spotdiagram.ts
